...
func (t *Tools) Slugify(s string) (string, error) {
	...
	if len(slug) == 0 {
		return "", errors.New("after removing characters, slug is zero lenghth")
	}
...
// PushJSONToRemote posts a arbitrary data to some URL as JSON, and returns the response, status code, and error, if any.
